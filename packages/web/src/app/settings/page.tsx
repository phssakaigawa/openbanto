            ...
            <>
              ...
              <Section title="コネクタ">
                ...
                */}
                  ...
                  !config.connectors?.slack?.agentsCanvas?.enabled && (
                    ...
                    >
                      ...
                      <div className="text-[length:var(--text-caption1)] text-[var(--text-secondary)]">
                        いま動いている全 Banto セッションが Slack の Canvas タブにライブ表示されます。
                ...
                >
                  今動いている Banto のセッション一覧（running / waiting / errored / idle）
                ...
                <FieldRow label="認証ディレクトリ">
                  <SettingsInput
                    ...
                    placeholder="デフォルト: ~/.openbanto/.whatsapp-auth"
                  />
                </FieldRow>
